...

{
	...
	private Domicilio domicilioCompuesta = new Domicilio();
	...
	public void setDomicilioCompuesta(Domicilio domicilioCompuesta) {
		this.domicilioCompuesta = domicilioCompuesta;
	}

	public Domicilio getDomicilioCompuesta() {
		return domicilioCompuesta;
	}
